        ...
        static void Main(string[] args)
        {
            ...
            switch (arguments.Option)
            {
                ...
                case ProgramOption.Post:
                    ...
                    var restaurantSettingses = JsonParser.ParseFile(arguments.JsonFilePath);
                    ...
                    {
                        SlackPoster.PostMenu(menus, arguments.SlackFilePath);
                    }
                    else
                    {
                        SlackPoster.UpdateMenu(menus, arguments.SlackFilePath);
                    }
